export const componentsList = [
  // MUI Components
  'Button', 'Select', 'Input', 'Grid', 'Card', 'Table', 'TextField', 'Dialog',

  // Bootstrap Components
  'Button', 'Dropdown', 'Form', 'InputGroup', 'Card', 'Table',

  // Ant Design Components
  'Button', 'Select', 'Input', 'Grid', 'Card', 'Table', 'Modal',

  // Chakra UI Components
  'Button', 'Select', 'Input', 'Grid', 'Box', 'Flex', 'Table',

  // Semantic UI Components
  'Button', 'Dropdown', 'Form', 'Card', 'Table', 'Modal',
